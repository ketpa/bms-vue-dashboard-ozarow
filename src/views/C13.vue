<template>
  <div id="wrapper" class="wrapper" :style="{ backgroundImage: `url(${require('@/assets/img/013.png')})` }">
    <div id="content">
      <ul></ul>
      <div id="punkty"></div>

      <div id="SYGN_013PJ1">
        <span class="lowered">{{ points.SYGN_013PJ1 ? 'Brudny' : 'Czysty' }}</span>
      </div>
      <div id="SYGN_013PJ1_img" v-if="points.SYGN_013PJ1 === 1">
