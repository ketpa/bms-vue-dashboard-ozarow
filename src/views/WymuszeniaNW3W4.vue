<template>
  <div class="page">
    <div class="menubottom">NW3, W4 &gt; Wymuszenia</div>
    ...
    <div class="pagebody">
      ...
      <table class="table">
        <tr>
          <td>Załączenie wymuszenia NW3</td>
          <td>
            <select v-model="form.s09136">
              <option value="0">Auto</option>
              <option value="1">Wymuszenie</option>
            </select>
            <button @click="send('s09136')">Zapisz</button>
          </td>
        </tr>

        <tr>
          <td>Wartość wymuszenia NW3</td>
          <td>
            <input v-model="form.t09168" type="number" min="0" max="100" step="1" />
            <button @click="send('t09168')">Zapisz</button>
          </td>
        </tr>

        <tr>
          <td>Załączenie wymuszenia 3NE1</td>
          <td>
            <select v-model="form.s09137">
              <option value="0">Auto</option>
              <option value="1">Wymuszenie</option>
            </select>
            <button @click="send('s09137')">Zapisz</button>
          </td>
        </tr>

        <tr>
          <td>Wartość wymuszenia 3NE1</td>
          <td>
            <input v-model="form.t09169" type="number" min="0" max="100" step="1" />
            <button @click="send('t09169')">Zapisz</button>
          </td>
        </tr>

        <tr>
          <td>Załączenie wymuszenia 3NV1</td>
          <td>
            <select v-model="form.s09138">
              <option value="0">Auto</option>
              <option value="1">Wymuszenie</option>
            </select>
            <button @click="send('s09138')">Zapisz</button>
          </td>
        </tr>

        <tr>
          <td>Wartość wymuszenia 3NV1</td>
          <td>
            <input v-model="form.t09170" type="number" min="0" max="100" step="1" />
            <button @click="send('t09170')">Zapisz</button>
          </td>
        </tr>
