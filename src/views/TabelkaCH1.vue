<template>
  <div class="page">
    <div class="menubottom">CH &gt; Chłodnia 1</div>

    <p class="title">Chiller CH1</p>
    ...
    <div class="pagebody">
      <table class="table">
        ...
        <tbody>
          <tr v-for="item in ch1Data" :key="item.Name">
  ...
  computed: {
    ch1Data() {
      return this.allData.filter(
        item =>
          item.Name.includes("CH1") ||
          item.Name.includes("STEROWANIE_ON_OFF_CH1")
      );
    }
  },
