<template>
  <div id="wrapper" class="wrapper" :style="{ backgroundImage: `url(${require('@/assets/img/018.png')})` }">
    <div id="content">
      <ul></ul>
      <div id="punkty"></div>
      ...
      <div id="SYGN_018PJ1_img" v-if="points.SYGN_017PJ1 === 1">
...
export default {
  ...
  methods: {
    fetchData() {
      axios.get('http://192.168.1.155:1880/C1.json') // 👈 zmienione
        .then(response => {
          const updatedPoints = {};
